...
public class Inventory extends Item { //Stores Item Stock Details
    ...
    private static final String INVENTORY_FILENAME = System.getProperty("user.dir") + "/src/Database/inventory.txt";
    private static final String STOCK_MOVEMENT_LOG_FILENAME = System.getProperty("user.dir") + "/src/Database/stockMovementLog.txt";
